...
class ResourceAdapter(
    ...
    override fun onBindViewHolder(holder: contentAdaterViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            if (position == 0)
                intent.setData(Uri.parse("https://www.lifehack.org/articles/featured/50-ways-to-increase-your-productivity.html"))
            else if (position == 1)
                intent.setData(Uri.parse("https://www.investopedia.com/terms/1/80-20-rule.asp#:~:text=The%2080%2D20%20rule%2C%20also,and%20make%20them%20the%20priority."))
            else if (position == 2)
                intent.setData(Uri.parse("https://www.mindtools.com/pages/article/newHTE_91.htm#:~:text=Eisenhower%2C%20who%20was%20quoting%20Dr,organized%20his%20workload%20and%20priorities."))
            else if (position == 3)
                intent.setData(Uri.parse("https://memory.ai/timely-blog/productivity-techniques"))
            else if (position == 4)
                intent.setData(Uri.parse("https://twitter.com/imshivkhera"))
            else if (position == 5)
                intent.setData(Uri.parse("https://twitter.com/RobinSharma"))
            else if (position == 6)
                intent.setData(Uri.parse("https://twitter.com/garyvee"))
            else if (position == 7)
                intent.setData(Uri.parse("https://twitter.com/GrantCardone"))
            else if (position == 8)
                intent.setData(Uri.parse("https://twitter.com/BrianTracy"))
            else if (position == 9)
                intent.setData(Uri.parse("https://twitter.com/OfficialJimRohn"))
            else if (position == 10)
